# Plan — Phase 2: Leg Tube Segment + Tube Sleeve Connector
...
3. Run each headlessly: `./run.sh part_01_leg_tube.py` and `./run.sh part_01b_tube_sleeve.py`. Confirm no traceback and export lines present.
4. Invoke `freecad-visual-validation` agent for each part; confirm PASS on all views.
